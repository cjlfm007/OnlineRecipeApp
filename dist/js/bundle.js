...
"use strict";
eval("\n\nvar _Search = __webpack_require__(!(function webpackMissingModule() { var e = new Error(\"Cannot find module './model/Search'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));\n\nvar _Search2 = _interopRequireDefault(_Search);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar search = new _Search2.default('pizza'); /*import str from './models/Search'\n                                            //import { add as a, multiply as m,ID} from './views/searchView';\n                                            import * as searchView from './views/searchView'\n                                            //console.log(`Using imported functions! ${a(ID,2)} and ${m(3,5)}.${str}}`);\n                                            console.log(`Using imported functions! ${searchView.add(searchView.ID,2)} and ${searchView.multiply(3,5)}.${str}}`);*/\n//3535bebde6997633c11f1d49881788cd\n//http://food2fork.com/api/search \n\nconsole.log(search);\n\n//# sourceURL=webpack:///./src/js/index.js?");
